...
def get_sketch_dictionary(class_name,draw_mode=True):
    """
    ...
    """
    # uncomment section to use train set instead 
    # for demo use: if the model sketches get very ugly
...
if __name__ == "__main__":
    """
    Usage: call get_sketch_dictionary and pass in class name
    """
    get_sketch_dictionary("apple")
    get_sketch_dictionary("baseball")
