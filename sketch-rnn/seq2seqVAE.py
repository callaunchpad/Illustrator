...
def get_default_hparams():
    ...
    params_dict = {
        ...
        'epochs': 50,  # 50: how many times to go over the full train set (on average, since batches are drawn randomly)
        ...
        # Architecture Params:
        'z_size': 32,  # Size of latent vector z. Recommended 32, 64 or 128.
